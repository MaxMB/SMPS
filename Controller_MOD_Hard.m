...
%%% System parameters
Lf = 90e-6;  % [H]   Inductor
RLf = 28e-3; % [Ohm] Inductor resistance
Cf = 610e-6; % [F]   Capacitor
RCf = 25e-3; % [Ohm] Capacitor resistance
Rl = 10;     % [Ohm] Load resistance
Vi = 179.6;    % [V]   Mean input voltage: 141.4 | 179.6 | 200
N = 1.3;     %       Transformer turns ratio
...
subplot(211), stairs(0:Ts:tf,d,'k'), grid on;
    title(['Forward Converter - Hard Mismatch - Vi=' ...
